...
export const flowBScreens = [
  ...
  {
    id: 'flowB_dd',
    clearOnBack: { intent: null, subContext: null },
    showSidebar: true,
    autoCapture: { sourceFlow: 'flowB', intent: 'due_diligence' },
    messageKey: 'flowB_dd.message',
    promptKey: 'flowB_dd.prompt',
    choices: [
      { labelKey: 'flowB_dd.choices.supplier', target: 'flowB_dd_sub', capture: { key: 'subContext', value: 'supplier' } },
      { labelKey: 'flowB_dd.choices.client',   target: 'flowB_dd_sub', capture: { key: 'subContext', value: 'client' } },
      { labelKey: 'flowB_dd.choices.partner',  target: 'flowB_dd_sub', capture: { key: 'subContext', value: 'partner' } },
      { labelKey: 'flowB_dd.choices.target',   target: 'flowB_dd_sub', capture: { key: 'subContext', value: 'investment_target' } },
      { labelKey: 'flowB_dd.choices.other',    target: 'flowB_dd_sub', capture: { key: 'subContext', value: 'other' } },
    ],
  },
  {
    id: 'flowB_dd_sub',
  ...
  },
  {
    ...
    choices: [
      { labelKey: 'flowB_lit.choices.civil',         target: 'flowB_lit_sub', capture: { key: 'subContext', value: 'civil_litigation' } },
      { labelKey: 'flowB_lit.choices.commercial',    target: 'flowB_lit_sub', capture: { key: 'subContext', value: 'commercial_dispute' } },
      { labelKey: 'flowB_lit.choices.assetTracing',  target: 'flowB_lit_sub', capture: { key: 'subContext', value: 'asset_tracing' } },
      { labelKey: 'flowB_lit.choices.preLitigation', target: 'flowB_lit_sub', capture: { key: 'subContext', value: 'pre_litigation' } },
    ],
  },
  {
    id: 'flowB_lit_sub',
